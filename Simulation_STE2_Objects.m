...
%     results{ iter, 2 } = b_f;
%     results{ iter, 3 } = LS;
%     save( 'Results_lambda_001_001_Objects.mat', 'results' )
...
%     results{ iter, 2 } = b_f;
%     results{ iter, 3 } = LS;
%     save( 'Results_lambda_5_5_Objects.mat', 'results' )
%     disp( [ '# of iter. = ', num2str( iter ) ] )
%     clear W_f b_f LS
% end; clear iter
% 
...
%     results{ iter, 2 } = b_f;
%     results{ iter, 3 } = LS;
%     save( 'Results_lambda_1000_1000_Objects.mat', 'results' )
%     disp( [ '# of iter. = ', num2str( iter ) ] )
%     clear W_f b_f LS
% end; clear iter
% 
