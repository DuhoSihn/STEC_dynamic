...
% % 
% % 
% % accLoc_1_trans = zeros( 9, length( noiseRanges ), 2, 2 );
% % accLoc_2_trans = zeros( 9, length( noiseRanges ), 2, 2 );
% % 
% % for fn = 1 : 2
% %     for noiseLevel = 1 : length( noiseRanges )
% %         for r = [ 5 : -1 : 1, 8 : -1 : 6 ]
...
% %             acc = abs( idx_out - idx_te );
% %             accH = histcounts( acc, [ -0.5 : 1 : 8.5 ] );
% %             accLoc_2_trans( :, noiseLevel, fn, 1 ) = accLoc_1_trans( :, noiseLevel, fn, 1 ) + transpose( accH );
% % 
% %             idx_out = classify( data_te, data_tr + ( 10 ^ (-8) * randn( size( data_tr ) ) ), idx_tr );
% %             acc = abs( idx_out - idx_te );
% %             accH = histcounts( acc, [ -0.5 : 1 : 8.5 ] );
% %             accLoc_2_trans( :, noiseLevel, fn, 2 ) = accLoc_1_trans( :, noiseLevel, fn, 2 ) + transpose( accH );
% % 
% %             clear data_tr data_te idx_tr idx_te idx_out acc accH
% % 
% % 
...
% % 
% % 
% % accDir_1_trans = zeros( 5, length( noiseRanges ), 2, 2 );
% % accDir_2_trans = zeros( 5, length( noiseRanges ), 2, 2 );
% % 
% % for fn = 1 : 2
% %     for noiseLevel = 1 : length( noiseRanges )
% % 
...
% xlabel( 'Noise level' )
% title( 'Upper' )
% legend( 'Naive Bayes; STEC', 'LDA; STEC', 'Naive Bayes; SEC', 'LDA; SEC', 'location', 'southwest' )
% 
...
% xlabel( 'Noise level' )
% title( 'Upper' )
% legend( 'Naive Bayes; STEC', 'LDA; STEC', 'Naive Bayes; TEC', 'LDA; TEC', 'location', 'southwest' )
% 
