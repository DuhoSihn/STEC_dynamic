function [ W_f, b_f, LS ] = STE2_learn_sgm( X, info_X_sX, io_f, hl_f, lambda, kWidth, cType, miniBatchSize, nPred, nMaxIter, varargin )
...
while stopCriterion == 0
    ...
    [ sX, sX_learn ] = STE2_gaze( sX, info_X_sX, nPred );
    ...
    for h = 1 : nH
        ...
        elseif strcmpi( cType{ h, 1 }, 'sparse' )
            sZ1{ h, 1 } = ( 2 * rand( miniBatchSize * ( prod( nPred, 2 ) - 2 ), nZ( h ) ) ) - 1;
        end
    end
