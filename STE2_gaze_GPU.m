function [ sX, sX_learn ] = STE2_gaze_GPU( sX, info_X_sX, nPred )
...
ttsX = NaN( miniBatchSize, nV, prod( nPred, 2 ), 'gpuArray' );
for iter = 1 : nPred( 2 )
    ...
    tsX = NaN( miniBatchSize, nV, nPred( 1 ), 'gpuArray' );
...
sX_learn = NaN( miniBatchSize * ( prod( nPred, 2 ) - 2 ), nV, 'gpuArray' );
